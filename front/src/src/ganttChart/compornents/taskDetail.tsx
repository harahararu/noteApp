...
const TaskDetail:FC<datailType> = () => {
    return (
        <div className="w-[600px] h-[700px] bg-white">
            ...
            <div className="w-full">
                <form action="">
                    ...
                    <div className="m-6">
                        <button className="w-full inline-flex h-12 items-center justify-center rounded-md bg-neutral-950 px-6 font-medium text-neutral-50 transition active:scale-110">Add</button>
                    </div>
                </form>
            </div>
        </div>
